  ...
  try {
    ...
    for (const post of samplePosts) {
      const query = `
        ...
        RETURNING id, title, slug, status, tags;
      `;
      ...
      console.log(`✅ Đã thêm: ${result.rows[0].title}`);
      console.log(`   Tags: ${result.rows[0].tags}\n`);
    }
...
// Chạy hàm seed
console.log('🔄 Đang thêm dữ liệu mẫu mới...\n');
seedPosts();
